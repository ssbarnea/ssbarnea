...
- 💬 ``@zbr`` nick on [libera.chat](https://web.libera.chat/?channel=#pycontribs) or [oftc](https://www.oftc.net/) irc networks, active on `#ansible-devtools`, `#zuul`, `#opendev`, `#oooq`, `#pycontribs`
